...
@section('title', 'Layanan Kartu Keluarga - Sukabumi One Access')
...
{{-- 1. HERO SECTION --}}
<section class="hero-ktp"> {{-- Class hero disamakan agar style tetap konsisten --}}
    ...
    <div class="max-w-7xl mx-auto relative z-10 text-center">
        <div class="reveal">
            ...
            <h1 class="text-3xl md:text-5xl font-extrabold text-white leading-tight tracking-tighter">
                Layanan <span class="text-accent">Kartu Keluarga</span>
            </h1>
            <p class="text-slate-400 mt-4 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed">
                Silakan pilih jenis permohonan Kartu Keluarga (KK) yang sesuai dengan kebutuhan administratif Anda.
            </p>
        </div>
    </div>
</section>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            ...
            @php
                $options = [
                    [
                        'title' => 'Keluarga Baru',
                        'desc' => 'Penerbitan KK bagi pasangan yang baru melangsungkan pernikahan dan membentuk keluarga sendiri.',
                        'icon' => 'bi-house-add-fill',
                        'color' => 'bg-blue-50 text-blue-600',
                        'route' => 'layanan.kk.baru'
                    ],
                    [
                        ...
                        'route' => 'layanan.kk.pisah'
                    ],
                    [
                        'title' => 'KK Hilang',
                        'desc' => 'Penerbitan ulang bagi warga yang kehilangan dokumen KK. Wajib melampirkan Surat Kehilangan Kepolisian.',
                        'icon' => 'bi-search',
                        'color' => 'bg-red-50 text-red-600',
                        'route' => 'layanan.kk.hilang'
                    ],
                    [
                        'title' => 'KK Rusak',
                        'desc' => 'Penggantian dokumen Kartu Keluarga yang kondisinya sudah rusak, robek, atau tidak terbaca.',
                        'icon' => 'bi-qr-code-scan',
                        'color' => 'bg-orange-50 text-orange-600',
                        'route' => 'layanan.kk.rusak'
                    ],
                    [
                        ...
                        'route' => 'layanan.kk.ubah'
                    ],
                    [
                        'title' => 'Numpang KK',
                        'desc' => 'Proses penggabungan anggota keluarga baru ke dalam Kartu Keluarga yang sudah ada.',
                        'icon' => 'bi-people-fill',
                        'color' => 'bg-sky-50 text-sky-600',
                        'route' => 'layanan.kk.numpang'
                    ]
                ];
            @endphp
            ...
            @foreach($options as $index => $opt)
                <div class="reveal">
                    <a href="{{ route($opt['route']) ?? '#' }}" class="option-card p-6 sm:p-10 group text-decoration-none">
                        ...
                        <div class="flex items-center justify-between pt-6 border-t border-slate-50" style="position: relative; z-index: 2;">
                            <span class="status-badge">
                                <i class="bi bi-lightning-charge-fill text-accent"></i> Verifikasi Online
                            </span>
        ...
        <div class="mt-16 reveal">
            <div class="bg-[#123457] border border-slate-100 rounded-[2.5rem] p-6 sm:p-8 flex items-start gap-5 shadow-2xl">
                <div class="w-12 h-12 rounded-2xl bg-white/10 backdrop-blur-md flex items-center justify-center text-accent shrink-0 shadow-lg border border-white/10">
                    <i class="bi bi-info-circle-fill text-xl"></i>
                </div>
                <div>
                    <h4 class="font-bold text-white mb-1">Penting: Persyaratan Digital</h4>
                    <p class="text-xs text-slate-400 leading-relaxed">
                        Pastikan seluruh berkas asli di-scan atau difoto dengan pencahayaan yang cukup. Format berkas yang didukung adalah <strong>JPG/PNG</strong> dengan ukuran maksimal <strong>2MB</strong> per file.
                    </p>
                </div>
            </div>
        </div>
...
@push('scripts')
<script>
    // Logic animasi reveal saat di-scroll
