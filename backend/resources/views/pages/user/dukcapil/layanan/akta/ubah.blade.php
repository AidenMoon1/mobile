...
@section('title', 'Pembetulan Akta Kelahiran - Sukabumi One Access')
...
<section class="form-header">
    ...
    <div class="max-w-4xl mx-auto relative z-10 text-center text-white">
        <div class="reveal">
            ...
            <p class="text-slate-400 mt-2 text-sm">Perbaikan Elemen Data pada Kutipan Akta Kelahiran</p>
        </div>
    </div>
</section>
        ...
        <form action="#" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="input-group-custom">
                        ...
                        <input type="text" name="nik_pemohon" id="nik_pemohon" maxlength="16" inputmode="numeric" placeholder="3272..." required>
                    </div>
                    <div class="input-group-custom">
                        <label>Nomor Kartu Keluarga (16 Digit)</label>
                        <input type="text" name="no_kk_pemohon" id="no_kk_pemohon" maxlength="16" inputmode="numeric" placeholder="3272..." required>
                    </div>
                    <div class="input-group-custom">
                    ...
                    <div class="input-group-custom md:col-span-2">
                        ...
                        <textarea name="keterangan" rows="2" placeholder="Jelaskan elemen data apa yang ingin dibetulkan"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <h3 class="text-lg font-bold text-primary">Rincian Akta Kelahiran</h3>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="input-group-custom md:col-span-2">
                        <label>Nomor Akta Kelahiran</label>
                        <input type="text" name="no_akta" placeholder="Lihat pada lembar Akta Kelahiran" required>
                    </div>
                    <div class="input-group-custom">
                        <label>NIK Pemilik Akta Kelahiran</label>
                        <input type="text" name="nik_pemilik" id="nik_pemilik" maxlength="16" inputmode="numeric" placeholder="3272..." required>
                    </div>
                    <div class="input-group-custom">
                    ...
                    <div class="input-group-custom md:col-span-2">
                        ...
                        <input type="text" name="no_kk_pemilik" id="no_kk_pemilik" maxlength="16" inputmode="numeric" placeholder="3272..." required>
                    </div>
                    <div class="input-group-custom">
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {{-- File 1: Akta Saat Ini --}}
                    <div class="space-y-3">
                        <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Foto Akta Kelahiran Yang Ada Saat Ini</p>
                        <div class="upload-box" onclick="document.getElementById('f1').click()">
                            <input type="file" id="f1" name="file_akta_lama" accept="image/*" class="hidden" onchange="previewFile(this, 1)">
                            <div id="ph1">
                                <i class="bi bi-file-earmark-text text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih Foto Akta</span>
                            </div>
                    ...
                    {{-- File 2: Dasar Perubahan --}}
                    <div class="space-y-3">
                        <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Dasar Perubahan (Ijazah / Penetapan)</p>
                        <div class="upload-box" onclick="document.getElementById('f2').click()">
                            <input type="file" id="f2" name="file_dasar_perubahan" accept="image/*" class="hidden" onchange="previewFile(this, 2)">
                            <div id="ph2">
                                <i class="bi bi-journal-check text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih Dokumen Dasar</span>
                            </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="upload-box" onclick="document.getElementById('f3').click()">
                            <input type="file" id="f3" name="file_pendukung1" accept="image/*" class="hidden" onchange="previewFile(this, 3)">
                            <div id="ph3">
                                <i class="bi bi-plus-circle text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih File Tambahan</span>
                            </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="upload-box" onclick="document.getElementById('f4').click()">
                            <input type="file" id="f4" name="file_pendukung2" accept="image/*" class="hidden" onchange="previewFile(this, 4)">
                            <div id="ph4">
                                <i class="bi bi-plus-circle text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih File Tambahan</span>
                            </div>
...
@push('scripts')
<script>
    // 1. LIMIT 16 DIGIT & NUMERIC ONLY (NIK & KK)
    const applyLimit = (id) => {
    ...
    const ids = ['nik_pemohon', 'no_kk_pemohon', 'nik_pemilik', 'no_kk_pemilik'];
    ids.forEach(id => applyLimit(id));
    ...
    // Fetch Sukabumi Kota Districts (ID: 3272)
