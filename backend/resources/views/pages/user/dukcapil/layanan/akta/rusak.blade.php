...
@section('title', 'Akta Kelahiran Rusak - Sukabumi One Access')
...
<section class="form-header">
    ...
    <div class="max-w-4xl mx-auto relative z-10 text-center text-white">
        <div class="reveal">
            ...
            <p class="text-slate-400 mt-2 text-sm">Penerbitan Ulang Akta Kelahiran Karena Kerusakan Dokumen</p>
        </div>
    </div>
</section>
        ...
        <form action="#" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="input-group-custom md:col-span-2">
                        ...
                        <textarea name="keterangan" rows="2" placeholder="Tuliskan keterangan mengenai kondisi kerusakan"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <h3 class="text-lg font-bold text-primary">Data Akta Kelahiran yang Rusak</h3>
                </div>
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {{-- File 1: Akta Rusak --}}
                    <div class="space-y-3">
                        <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Foto Akta Kelahiran Yang Rusak</p>
                        <div class="upload-box" onclick="document.getElementById('f1').click()">
                            <input type="file" id="f1" name="file_akta_rusak" accept="image/*" class="hidden" onchange="previewFile(this, 1)">
                            <div id="ph1">
                                <i class="bi bi-file-earmark-break text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih Foto Akta Rusak</span>
                            </div>
                    ...
                    {{-- File 2: Pendukung --}}
                    <div class="space-y-3">
                        <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Foto Dokumen Pendukung Lainnya</p>
                        <div class="upload-box" onclick="document.getElementById('f2').click()">
                            ...
                            <div id="ph2">
                                ...
                                <span class="text-[10px] font-bold text-slate-400">Pilih Dokumen (KK/KTP)</span>
                            </div>
...
@push('scripts')
<script>
    // 1. LIMIT DIGIT & NUMERIC ONLY (NIK & KK)
    const applyLimit = (id) => {
