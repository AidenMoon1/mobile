...
@section('title', 'Pindah Keluar Kota - Sukabumi One Access')
    ...
    <div class="max-w-4xl mx-auto relative z-10 text-center text-white">
        <div class="reveal">
            <nav class="flex justify-center items-center gap-2 text-accent text-[10px] font-bold uppercase tracking-[0.2em] mb-4">
                ...
                <i class="bi bi-chevron-right text-[8px]"></i>
                <span>Pindah Keluar Kota</span>
            </nav>
            <h1 class="text-3xl md:text-4xl font-extrabold tracking-tighter">Formulir Pengajuan</h1>
            <p class="text-slate-400 mt-2 text-sm">Pengajuan Surat Keterangan Pindah (SKP) Antar Kabupaten/Provinsi</p>
        </div>
    </div>
</section>
        ...
        <form action="#" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <h3 class="text-lg font-bold text-primary">Data Alamat Asal Saat Ini</h3>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="input-group-custom"><label>Kabupaten / Kota</label><select name="kota_asal" id="kota_asal" required disabled></select></div>
                    <div class="input-group-custom"><label>Kecamatan</label><select name="kec_asal" id="kec_asal" required disabled></select></div>
                    <div class="input-group-custom"><label>Kelurahan / Desa</label><select name="kel_asal" id="kel_asal" required disabled></select></div>
                    <div class="input-group-custom md:col-span-2"><label>Alamat Lengkap</label><input type="text" name="alamat_asal" placeholder="Jalan, No Rumah" required></div>
                    <div class="input-group-custom"><label>RT</label><input type="text" name="rt_asal" id="rt_asal" maxlength="3" placeholder="000"></div>
                    <div class="input-group-custom"><label>RW</label><input type="text" name="rw_asal" id="rw_asal" maxlength="3" placeholder="000"></div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <h3 class="text-lg font-bold text-primary">Data Alamat Tujuan (Luar Kota)</h3>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="input-group-custom"><label>Kabupaten / Kota</label><select name="kota_tujuan" id="kota_tujuan" required disabled></select></div>
                    <div class="input-group-custom"><label>Kecamatan</label><select name="kec_tujuan" id="kec_tujuan" required disabled></select></div>
                    <div class="input-group-custom"><label>Kelurahan / Desa</label><select name="kel_tujuan" id="kel_tujuan" required disabled></select></div>
                    <div class="input-group-custom md:col-span-2"><label>Alamat Lengkap Tujuan</label><input type="text" name="alamat_tujuan" placeholder="Alamat lengkap di kota tujuan" required></div>
                    <div class="input-group-custom"><label>RT</label><input type="text" name="rt_tujuan" id="rt_tujuan" maxlength="3" placeholder="000"></div>
                    <div class="input-group-custom"><label>RW</label><input type="text" name="rw_tujuan" id="rw_tujuan" maxlength="3" placeholder="000"></div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                <div class="flex justify-between items-center mb-8">
                    ...
                    <button type="button" onclick="addRow()" class="py-2 px-4 bg-accent text-primary rounded-xl font-bold text-xs">+ Tambah Data</button>
                </div>
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-3 md:col-span-2">
                        <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Foto Formulir F-1.03 (Perpindahan)</p>
...
<script>
    ...
    // 2. PREVIEW FILE (Dgn Filter Gambar & Ukuran)
    ...
    // 3. REMOVE PREVIEW (Fungsi Hapus)
    function removePreview(event, inputId, index) {
        event.stopPropagation(); // Mencegah window file picker terbuka kembali
