...
@section('title', 'Layanan E-KTP - Sukabumi One Access')
    ...
    <div class="max-w-7xl mx-auto relative z-10 text-center">
        <div class="reveal">
            ...
            <h1 class="text-3xl md:text-5xl font-extrabold text-white leading-tight tracking-tighter">
                Permohonan <span class="text-accent">KTP-el</span>
            </h1>
...
<section class="py-16 sm:py-24 bg-slate-50 min-h-[60vh]">
    <div class="max-w-6xl mx-auto px-4 sm:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            ...
            @php
                $options = [
                    [
                        'title' => 'Karena Hilang',
                        'desc' => 'Penerbitan ulang bagi warga yang kehilangan KTP-el. Wajib melampirkan Surat Kehilangan dari Kepolisian.',
                        'icon' => 'bi-search',
                        'color' => 'bg-red-50 text-red-600',
                        'route' => 'layanan.ktp.hilang'
                    ],
                    [
                        'title' => 'Karena Rusak',
                        'desc' => 'Penerbitan ulang bagi warga yang kondisi fisik KTP-el miliknya sudah tidak terbaca atau patah.',
                        'icon' => 'bi-qr-code-scan',
                        'color' => 'bg-orange-50 text-orange-600',
                        'route' => 'layanan.ktp.rusak'
                    ],
                    [
                        'title' => 'Karena Perpindahan',
                        'desc' => 'Penerbitan KTP-el bagi warga yang baru saja pindah domisili (Masuk ke Kota Sukabumi).',
                        'icon' => 'bi-pci-card',
                        'color' => 'bg-blue-50 text-blue-600',
                        'route' => 'layanan.ktp.pindah'
                    ],
                    [
        ...
        <div class="mt-16 reveal">
            <div class="bg-white border border-slate-200 rounded-[2rem] p-6 sm:p-8 flex items-start gap-5 shadow-sm">
                <div class="w-12 h-12 rounded-2xl bg-primary flex items-center justify-center text-accent shrink-0 shadow-lg shadow-primary/20">
                    <i class="bi bi-info-circle-fill text-xl"></i>
                </div>
                <div>
                    <h4 class="font-bold text-primary mb-1">Catatan Penting</h4>
                    <p class="text-xs text-slate-500 leading-relaxed">
                        Pastikan Anda sudah menyiapkan dokumen pendukung dalam format digital (Foto/Scan) sebelum memulai pengajuan. Ukuran file maksimal per dokumen adalah <strong>2MB</strong> dalam format <strong>JPG/PNG</strong>.
                    </p>
                </div>
            </div>
        </div>
