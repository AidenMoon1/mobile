...
@section('title', 'Pembetulan Akta Kematian - Sukabumi One Access')
...
<section class="form-header">
    ...
    <div class="max-w-4xl mx-auto relative z-10 text-center text-white">
        <div class="reveal">
            ...
            <p class="text-slate-400 mt-2 text-sm">Perbaikan Elemen Data pada Kutipan Akta Kematian</p>
        </div>
    </div>
</section>
        ...
        <form action="#" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="input-group-custom md:col-span-2">
                        ...
                        <textarea name="keterangan" rows="2" placeholder="Jelaskan bagian data mana yang ingin dibetulkan..."></textarea>
                    </div>
                </div>
            </div>

            {{-- CARD 2: DATA AKTA KEMATIAN --}}
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                <div class="flex items-center gap-4 mb-8">
                    <div class="w-10 h-10 rounded-xl bg-accent text-primary flex items-center justify-center shadow-lg">
                        <i class="bi bi-file-earmark-check-fill"></i>
                    </div>
                    <h3 class="text-lg font-bold text-primary">Rincian Akta Kematian</h3>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="input-group-custom md:col-span-2">
                        <label>Nomor Akta Kematian</label>
                        <input type="text" name="no_akta" placeholder="Lihat pada lembar Akta Kematian" required>
                    </div>
                    <div class="input-group-custom">
                        <label>NIK Pemilik Akta Kematian</label>
                        <input type="text" name="nik_pemilik" id="nik_pemilik" maxlength="16" required>
                    </div>
                    <div class="input-group-custom">
                        <label>Nama Pemilik Akta Kematian</label>
                        <input type="text" name="nama_pemilik" required>
                    </div>
                    <div class="input-group-custom md:col-span-2">
                        <label>Nomor Kartu Keluarga Pemilik</label>
                        <input type="text" name="no_kk_pemilik" id="no_kk_pemilik" maxlength="16" required>
                    </div>
                    <div class="input-group-custom">
                        <label>Tempat Kematian (Kota/Kabupaten)</label>
                        <input type="text" name="tempat_kematian" placeholder="Contoh: Kota Sukabumi" required>
                    </div>
                    <div class="input-group-custom">
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {{-- File 1: Akta Kematian Lama --}}
                    <div class="space-y-3">
                        <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Foto Akta Kematian Saat Ini</p>
                    ...
                    <div class="space-y-3">
                        <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Dasar Perubahan (Ijazah/SK)</p>
                        <div class="upload-box" onclick="document.getElementById('f2').click()">
                            <input type="file" id="f2" name="file_dasar" accept="image/*" class="hidden" onchange="previewFile(this, 2)">
                            <div id="ph2">
                    ...
                    {{-- File 3: Pendukung 1 --}}
                    <div class="space-y-3">
                        <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Dokumen Pendukung 1</p>
                    ...
                    {{-- File 4: Pendukung 2 --}}
                    <div class="space-y-3">
                        <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Dokumen Pendukung 2</p>
...
<script>
    ...
    ['nik_pemohon', 'no_kk_pemohon', 'nik_pemilik', 'no_kk_pemilik'].forEach(id => applyLimit(id));
    ...
    // 3. API WILAYAH (SUKABUMI CITY ONLY)
