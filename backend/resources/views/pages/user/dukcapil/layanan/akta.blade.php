...
@section('title', 'Layanan Akta Kelahiran - Sukabumi One Access')
    ...
    <div class="max-w-7xl mx-auto relative z-10 text-center">
        <div class="reveal">
            ...
            <h1 class="text-3xl md:text-5xl font-extrabold text-white leading-tight tracking-tighter">
                Layanan <span class="text-accent">Akta Kelahiran</span>
            </h1>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-8">
            ...
            @php
                $options = [
                    [
                        ...
                        'desc' => 'Pencatatan kelahiran untuk anak yang baru lahir atau warga yang belum pernah memiliki kutipan Akta Kelahiran.',
                        'icon' => 'bi-hearts',
                        'color' => 'bg-blue-50 text-blue-600',
                        'route' => 'layanan.akta.baru'
                    ],
                    [
                        'title' => 'Karena Hilang',
                        'desc' => 'Penerbitan ulang kutipan Akta Kelahiran yang hilang. Wajib melampirkan Surat Kehilangan asli dari Kepolisian.',
                        'icon' => 'bi-search',
                        'color' => 'bg-red-50 text-red-600',
                        'route' => 'layanan.akta.hilang'
                    ],
                    [
                        'title' => 'Karena Rusak',
                    ...
                    <a href="{{ route($opt['route']) ?? '#' }}" class="option-card p-6 sm:p-10 group text-decoration-none">
                        ...
                        <div class="flex items-center justify-between pt-6 border-t border-slate-50" style="position: relative; z-index: 2;">
                            <span class="status-badge">
                                <i class="bi bi-lightning-charge-fill text-accent"></i> Proses Digital
                            </span>
        ...
        <div class="mt-16 reveal">
            <div class="bg-[#123457] border border-slate-100 rounded-[2.5rem] p-6 sm:p-8 flex items-start gap-5 shadow-2xl">
                ...
                <div>
                    <h4 class="font-bold text-white mb-1 tracking-tight">Ketentuan Umum</h4>
                    <p class="text-xs text-slate-400 leading-relaxed">
                        Pastikan data orang tua dan anak sudah tercatat dalam sistem kependudukan (KK) Kota Sukabumi. Siapkan dokumen asli dalam format <strong>JPG/PNG</strong> dengan ukuran maksimal <strong>2MB</strong> per file.
                    </p>
                </div>
            </div>
        </div>
