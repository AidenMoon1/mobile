...
@section('title', 'Layanan Akta Kematian - Sukabumi One Access')
    ...
    <div class="max-w-7xl mx-auto relative z-10 text-center">
        <div class="reveal">
            ...
            <h1 class="text-3xl md:text-5xl font-extrabold text-white leading-tight tracking-tighter">
                Layanan <span class="text-accent">Akta Kematian</span>
            </h1>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-8">
            ...
            @php
                $options = [
                    [
                        ...
                        'desc' => 'Pelaporan peristiwa kematian baru untuk diterbitkan kutipan Akta Kematian resmi.',
                        'icon' => 'bi-clipboard2-pulse',
                        'color' => 'bg-blue-50 text-blue-600',
                        'route' => 'layanan.kematian.baru'
                    ],
                    [
                        'title' => 'Karena Hilang',
                        'desc' => 'Penerbitan ulang kutipan Akta Kematian yang hilang. Wajib melampirkan Surat Kehilangan dari Kepolisian.',
                        'icon' => 'bi-search',
                        'color' => 'bg-red-50 text-red-600',
                        'route' => 'layanan.kematian.hilang'
                    ],
                    [
                        'title' => 'Karena Rusak',
        ...
        <div class="mt-16 reveal">
            <div class="bg-[#123457] border border-slate-100 rounded-[2.5rem] p-6 sm:p-8 flex items-start gap-5 shadow-2xl">
                ...
                <div>
                    <h4 class="font-bold text-white mb-1 tracking-tight">Catatan Pelaporan</h4>
                    <p class="text-xs text-slate-400 leading-relaxed">
                        Pelaporan kematian sangat penting untuk menjaga integritas data kependudukan. Mohon siapkan Surat Keterangan Kematian dari RS/Kelurahan dalam format <strong>JPG/PNG</strong> (Maks <strong>2MB</strong>).
                    </p>
                </div>
            </div>
        </div>
