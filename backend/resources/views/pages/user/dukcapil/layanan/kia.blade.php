...
@section('title', 'Layanan KIA - Sukabumi One Access')
...
{{-- 1. HERO SECTION --}}
<section class="hero-ktp"> {{-- Menggunakan class hero yang sama agar konsisten --}}
    ...
    <div class="max-w-7xl mx-auto relative z-10 text-center">
        <div class="reveal">
            ...
            <h1 class="text-3xl md:text-5xl font-extrabold text-white leading-tight tracking-tighter">
                Layanan <span class="text-accent">Kartu Identitas Anak</span>
            </h1>
            <p class="text-slate-400 mt-4 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed">
                Penerbitan identitas resmi untuk penduduk berusia di bawah 17 tahun untuk meningkatkan pendataan dan perlindungan anak.
            </p>
        </div>
    </div>
</section>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-8">
            ...
            @php
                $options = [
                    [
                        ...
                        'desc' => 'Pengajuan kartu identitas bagi anak yang baru lahir atau belum pernah memiliki KIA sebelumnya.',
                        'icon' => 'bi-person-plus-fill',
                        'color' => 'bg-blue-50 text-blue-600',
                        'route' => 'layanan.kia.baru'
                    ],
                    [
                        'title' => 'Karena Hilang',
                        'desc' => 'Penerbitan ulang kutipan KIA yang hilang. Wajib melampirkan Surat Tanda Laporan Kehilangan dari Kepolisian.',
                        'icon' => 'bi-search',
                        'color' => 'bg-red-50 text-red-600',
                        'route' => 'layanan.kia.hilang'
                    ],
                    [
                        'title' => 'Karena Rusak',
                        'desc' => 'Penggantian fisik kartu KIA yang patah, terkelupas, atau elemen datanya sudah tidak terbaca jelas.',
                        'icon' => 'bi-qr-code-scan',
                        'color' => 'bg-orange-50 text-orange-600',
                        'route' => 'layanan.kia.rusak'
                    ],
                    [
                        'title' => 'Alasan Lainnya',
                        'desc' => 'Penerbitan KIA karena adanya perubahan data identitas anak atau alasan administratif lainnya.',
                        'icon' => 'bi-patch-question-fill',
                        'color' => 'bg-indigo-50 text-indigo-600',
                        'route' => 'layanan.kia.ubah'
                    ]
                ];
            @endphp
                ...
                <div class="reveal">
                    <a href="{{ route($opt['route']) ?? '#' }}" class="option-card p-6 sm:p-10 group text-decoration-none">
                        ...
                        <div>
                            ...
                            <h3 class="option-card-title text-xl sm:text-2xl font-black text-primary-dark mb-3 group-hover:text-primary transition-colors leading-tight">
                                {{ $opt['title'] }}
                            </h3>
                        ...
                        <div class="flex items-center justify-between pt-6 border-t border-slate-50">
                            <span class="status-badge">
                                <i class="bi bi-lightning-charge-fill text-accent"></i> Verifikasi Digital
                            </span>
        ...
        <div class="mt-16 reveal">
            <div class="bg-[#123457] border border-slate-100 rounded-[2.5rem] p-6 sm:p-8 flex items-start gap-5 shadow-2xl">
                <div class="w-12 h-12 rounded-2xl bg-white/10 backdrop-blur-md flex items-center justify-center text-accent text-xl shrink-0 shadow-lg border border-white/10">
                    <i class="bi bi-info-circle-fill"></i>
                </div>
                <div>
                    <h4 class="font-bold text-white mb-1 tracking-tight">Persyaratan Umum KIA</h4>
                    <p class="text-xs text-slate-400 leading-relaxed">
                        Anak harus terdaftar dalam Kartu Keluarga (KK) Kota Sukabumi. Untuk anak usia di atas 5 tahun, wajib melampirkan pas foto anak. Format dokumen <strong>JPG/PNG</strong> maksimal <strong>2MB</strong>.
                    </p>
                </div>
            </div>
        </div>
