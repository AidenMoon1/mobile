...
@section('title', 'Perubahan Data KTP - Sukabumi One Access')
...
<section class="form-header">
    ...
    <div class="max-w-4xl mx-auto relative z-10 text-center text-white">
        <div class="reveal">
            ...
            <p class="text-slate-400 mt-2 text-sm">Pembaruan Elemen Data pada KTP-el</p>
        </div>
    </div>
</section>
...
<section class="pb-24 bg-slate-50 min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 form-container">
        ...
        <form action="{{ route('layanan.ktp.ubah.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {{-- Spesifik Perubahan Data --}}
                    <div class="input-group-custom md:col-span-2">
                        <label>Elemen Data yang Diubah</label>
                        <select name="jenis_perubahan" required>
                            ...
                            <option value="Gelar / Pendidikan">Pendidikan / Gelar</option>
                            <option value="Pekerjaan">Pekerjaan</option>
                            <option value="Alamat">Alamat (Dalam Kota)</option>
                            <option value="Lainnya">Lainnya (Perbaikan Typo)</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal" style="transition-delay: 200ms">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {{-- File 1 --}}
                    <div class="space-y-3">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Foto KK Baru Karena Perubahan Data</p>
                        <div class="upload-box" onclick="document.getElementById('file_kehilangan').click()">
                            ...
                            <div id="placeholder1">
                                ...
                                <span class="text-[10px] font-bold text-slate-400">Pilih Foto Kartu Keluarga Baru</span>
                            </div>
                            <div id="previewWrap1" class="preview-wrap mx-auto">
                                <img id="preview1" class="preview-img">
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_kehilangan', 1)">
...
<script>
    ...
    function removePreview(event, inputId, index) {
        event.stopPropagation(); // Mencegah picker file terbuka otomatis
