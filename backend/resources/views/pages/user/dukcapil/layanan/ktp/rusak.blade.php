...
@section('title', 'KTP Rusak - Sukabumi One Access')
...
<section class="form-header">
    ...
    <div class="max-w-4xl mx-auto relative z-10 text-center text-white">
        <div class="reveal">
            ...
            <p class="text-slate-400 mt-2 text-sm">Penggantian KTP-el karena Kondisi Rusak</p>
        </div>
    </div>
</section>
...
<section class="pb-24 bg-slate-50 min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 form-container">
        ...
        <form action="{{ route('layanan.ktp.rusak.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="input-group-custom md:col-span-2">
                        <label>Penjelasan Kerusakan (Opsional)</label>
                        <textarea name="keterangan" rows="3" placeholder="Contoh: Chip tidak terbaca / Fisik KTP Patah..."></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {{-- File 1: KTP Rusak --}}
                    <div class="space-y-3">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Foto Fisik KTP-el Rusak</p>
                        <div class="upload-box" onclick="document.getElementById('file_rusak').click()">
                            <input type="file" id="file_rusak" name="file_rusak" accept="image/*" class="hidden" onchange="previewFile(this, 1)">
                            <div id="placeholder1">
                                <i class="bi bi-image text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih Foto KTP Rusak</span>
                            </div>
                            <div id="previewWrap1" class="preview-wrap mx-auto">
                                <img id="preview1" class="preview-img">
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_rusak', 1)">
                    ...
                    {{-- File 2: Pendukung --}}
                    <div class="space-y-3">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Foto Pendukung Lainnya ( Jika Diperlukan )</p>
                        <div class="upload-box" onclick="document.getElementById('file_kk').click()">
                            ...
                            <div id="placeholder2">
                                <i class="bi bi-image text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih Foto Pendukung</span>
                            </div>
...
<script>
    ...
    // Tambah fungsi hapus preview
    function removePreview(event, inputId, index) {
        event.stopPropagation(); // Biar file picker gak kebuka lagi
