...
@section('title', 'Penerbitan KK Hilang - Sukabumi One Access')
...
<section class="form-header">
    ...
    <div class="max-w-4xl mx-auto relative z-10 text-center text-white">
        <div class="reveal">
            ...
            <p class="text-slate-400 mt-2 text-sm">Penerbitan Ulang Kartu Keluarga Karena Kehilangan</p>
        </div>
    </div>
</section>
        ...
        <form action="#" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="input-group-custom md:col-span-2">
                        ...
                        <textarea name="keterangan" rows="3" placeholder="Jelaskan kronologi singkat atau informasi tambahan"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal" style="transition-delay: 200ms">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {{-- File 1: Surat Kehilangan --}}
                    <div class="space-y-3">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Foto Surat Kehilangan Kepolisian</p>
                    ...
                    {{-- File 2: KTP Pemohon --}}
                    <div class="space-y-3">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Foto KTP-el Pemohon</p>
                    ...
                    <div class="space-y-3 md:col-span-2">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Fotocopy KK (Jika Ada)</p>
                        <div class="upload-box" onclick="document.getElementById('file_kk_copy').click()">
                            <input type="file" id="file_kk_copy" name="file_kk_copy" accept="image/*" class="hidden" onchange="previewFile(this, 3)">
                            <div id="placeholder3">
                                <i class="bi bi-files text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih Fotocopy KK (Opsional)</span>
                            </div>
                            <div id="previewWrap3" class="preview-wrap mx-auto">
                                <img id="preview3" class="preview-img">
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_kk_copy', 3)">
                                    <i class="bi bi-trash3-fill"></i>
                                </button>
                            </div>
                        </div>
...
<script>
    ...
    function removePreview(event, inputId, index) {
        event.stopPropagation(); // Biar window file picker tidak terbuka lagi
