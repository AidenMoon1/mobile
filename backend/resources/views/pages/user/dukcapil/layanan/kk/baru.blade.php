...
@section('title', 'Pembuatan Kartu Keluarga Baru - Sukabumi One Access')
...
<section class="form-header">
    ...
    <div class="max-w-4xl mx-auto relative z-10 text-center text-white">
        <div class="reveal">
            ...
            <p class="text-slate-400 mt-2 text-sm">Pembuatan Kartu Keluarga Baru</p>
        </div>
    </div>
</section>
        ...
        <form action="#" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="input-group-custom">
                        <label>RT</label>
                        <input type="text" name="rt" maxlength="3" inputmode="numeric" placeholder="001" required>
                    </div>
                    <div class="input-group-custom">
                        <label>RW</label>
                        <input type="text" name="rw" maxlength="3" inputmode="numeric" placeholder="001" required>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal" style="transition-delay: 200ms">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {{-- File 1: Buku Nikah --}}
                    <div class="space-y-3">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Foto Buku Nikah / Akta Perceraian</p>
                        <div class="upload-box" onclick="document.getElementById('file_nikah').click()">
                            <input type="file" id="file_nikah" name="file_nikah" accept="image/*" class="hidden" onchange="previewFile(this, 1)">
                            <div id="placeholder1">
                                <i class="bi bi-image text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih Foto Buku Nikah / Akta Perceraian</span>
                            </div>
                            <div id="previewWrap1" class="preview-wrap mx-auto">
                                <img id="preview1" class="preview-img">
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_nikah', 1)">
                    ...
                    {{-- File 2: KK Suami --}}
                    <div class="space-y-3">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Foto Kartu Keluarga Suami</p>
                        <div class="upload-box" onclick="document.getElementById('file_kk_suami').click()">
                            <input type="file" id="file_kk_suami" name="file_kk_suami" accept="image/*" class="hidden" onchange="previewFile(this, 2)">
                            <div id="placeholder2">
                                <i class="bi bi-image text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih Foto KK Suami</span>
                            </div>
                            <div id="previewWrap2" class="preview-wrap mx-auto">
                                <img id="preview2" class="preview-img">
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_kk_suami', 2)">
                                    <i class="bi bi-trash3-fill"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    {{-- File 3: KK Istri --}}
                    <div class="space-y-3">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Foto Kartu Keluarga Istri</p>
                        <div class="upload-box" onclick="document.getElementById('file_kk_istri').click()">
                            <input type="file" id="file_kk_istri" name="file_kk_istri" accept="image/*" class="hidden" onchange="previewFile(this, 3)">
                            <div id="placeholder3">
                                <i class="bi bi-image text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih Foto KK Istri</span>
                            </div>
                            <div id="previewWrap3" class="preview-wrap mx-auto">
                                <img id="preview3" class="preview-img">
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_kk_istri', 3)">
                                    <i class="bi bi-trash3-fill"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    {{-- File 4: Surat Pindah --}}
                    <div class="space-y-3">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Foto Surat Pindah (Jika Diperlukan)</p>
                        <div class="upload-box" onclick="document.getElementById('file_surat_pindah').click()">
                            <input type="file" id="file_surat_pindah" name="file_surat_pindah" accept="image/*" class="hidden" onchange="previewFile(this, 4)">
                            <div id="placeholder4">
                                <i class="bi bi-image text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih Foto Surat Pindah</span>
                            </div>
                            <div id="previewWrap4" class="preview-wrap mx-auto">
                                <img id="preview4" class="preview-img">
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_surat_pindah', 4)">
                                    <i class="bi bi-trash3-fill"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    {{-- File 5: SPTJM --}}
                    <div class="space-y-3">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">SPTJM Perkawinan (Jika Tidak Ada Buku Nikah)</p>
                        <div class="upload-box" onclick="document.getElementById('file_sptjm').click()">
                            <input type="file" id="file_sptjm" name="file_sptjm" accept="image/*" class="hidden" onchange="previewFile(this, 5)">
                            <div id="placeholder5">
                                <i class="bi bi-image text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih Foto SPTJM Perkawinan</span>
                            </div>
                            <div id="previewWrap5" class="preview-wrap mx-auto">
                                <img id="preview5" class="preview-img">
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_sptjm', 5)">
                                    <i class="bi bi-trash3-fill"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    {{-- File 6: Pendukung 1 --}}
                    <div class="space-y-3">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Dokumen Pendukung 1 (Jika Diperlukan)</p>
                        <div class="upload-box" onclick="document.getElementById('file_pendukung_1').click()">
                            <input type="file" id="file_pendukung_1" name="file_pendukung_1" accept="image/*" class="hidden" onchange="previewFile(this, 6)">
                            <div id="placeholder6">
                                <i class="bi bi-image text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih Dokumen Pendukung 1</span>
                            </div>
                            <div id="previewWrap6" class="preview-wrap mx-auto">
                                <img id="preview6" class="preview-img">
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_pendukung_1', 6)">
                                    <i class="bi bi-trash3-fill"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="space-y-3 md:col-span-2">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Dokumen Pendukung 2 (Jika Diperlukan)</p>
                        <div class="upload-box" onclick="document.getElementById('file_pendukung_2').click()">
                            <input type="file" id="file_pendukung_2" name="file_pendukung_2" accept="image/*" class="hidden" onchange="previewFile(this, 7)">
                            <div id="placeholder7">
                                <i class="bi bi-image text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih Dokumen Pendukung 2</span>
                            </div>
                            <div id="previewWrap7" class="preview-wrap mx-auto">
                                <img id="preview7" class="preview-img">
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_pendukung_2', 7)">
                                    <i class="bi bi-trash3-fill"></i>
                                </button>
                            </div>
                        </div>
...
<script>
    ...
    // Update fungsi preview untuk mendukung index wrap
    ...
    function removePreview(event, inputId, index) {
        ...
        placeholder.style.display = 'block'; // Munculkan kembali placeholder
    }
