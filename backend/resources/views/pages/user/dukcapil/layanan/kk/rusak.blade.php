...
@section('title', 'Penerbitan KK Rusak - Sukabumi One Access')
...
<section class="form-header">
    ...
    <div class="max-w-4xl mx-auto relative z-10 text-center text-white">
        <div class="reveal">
            ...
            <p class="text-slate-400 mt-2 text-sm">Penerbitan Ulang Kartu Keluarga Karena Kondisi Rusak</p>
        </div>
    </div>
</section>
        ...
        <form action="#" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="input-group-custom md:col-span-2">
                        ...
                        <textarea name="keterangan" rows="3" placeholder="Tuliskan keterangan mengenai kondisi kerusakan KK"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal" style="transition-delay: 200ms">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {{-- File 1: KK Rusak --}}
                    <div class="space-y-3">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Foto Kartu Keluarga yang Rusak</p>
                        <div class="upload-box" onclick="document.getElementById('file_kk_rusak').click()">
                            <input type="file" id="file_kk_rusak" name="file_kk_rusak" accept="image/*" class="hidden" onchange="previewFile(this, 1)">
                            <div id="placeholder1">
                                <i class="bi bi-file-earmark-x text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih Foto KK yang Rusak</span>
                            </div>
                            <div id="previewWrap1" class="preview-wrap mx-auto">
                                <img id="preview1" class="preview-img">
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_kk_rusak', 1)">
                    ...
                    {{-- File 2: Pendukung --}}
                    <div class="space-y-3">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Dokumen Pendukung Lainnya (Opsional)</p>
                        <div class="upload-box" onclick="document.getElementById('file_pendukung').click()">
                            ...
                            <div id="previewWrap2" class="preview-wrap mx-auto">
                                ...
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_pendukung', 2)">
                                    <i class="bi bi-trash3-fill"></i>
                                </button>
                            </div>
                        </div>
...
<script>
    ...
    function removePreview(event, inputId, index) {
        event.stopPropagation(); // Mencegah form file picker terbuka kembali
