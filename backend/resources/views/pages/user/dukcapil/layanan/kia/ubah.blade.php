...
@section('title', 'KIA Alasan Lain - Sukabumi One Access')
...
<section class="form-header">
    ...
    <div class="max-w-4xl mx-auto relative z-10 text-center text-white">
        <div class="reveal">
            ...
            <p class="text-slate-400 mt-2 text-sm">Penerbitan KIA Karena Perubahan Data atau Alasan Lainnya</p>
        </div>
    </div>
</section>
        ...
        <form action="#" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="input-group-custom md:col-span-2">
                        ...
                        <textarea name="keterangan" rows="3" placeholder="Tuliskan alasan perubahan data atau alasan lainnya"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal" style="transition-delay: 200ms">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {{-- File 1: KK Baru --}}
                    <div class="space-y-3">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Foto Kartu Keluarga Baru</p>
                        <div class="upload-box" onclick="document.getElementById('file_kk').click()">
                            ...
                            <div id="placeholder1">
                                ...
                                <span class="text-[10px] font-bold text-slate-400">Pilih Foto KK Terbaru</span>
                            </div>
                    ...
                    {{-- File 2: Pas Foto --}}
                    <div class="space-y-3">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Pas Foto Berwarna (Jika Belum Berfoto)</p>
                        <div class="upload-box" onclick="document.getElementById('file_foto').click()">
                            <input type="file" id="file_foto" name="file_foto" accept="image/*" class="hidden" onchange="previewFile(this, 2)">
                            <div id="placeholder2">
                                <i class="bi bi-person-bounding-box text-3xl text-slate-300 block mb-2"></i>
                                <span class="text-[10px] font-bold text-slate-400">Pilih Pas Foto Berwarna Anak</span>
                            </div>
                            <div id="previewWrap2" class="preview-wrap mx-auto">
                                <img id="preview2" class="preview-img">
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_foto', 2)">
                                    <i class="bi bi-trash3-fill"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="space-y-3 md:col-span-2">
                        <p class="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Foto Dokumen Pendukung Lainnya</p>
                        <div class="upload-box" onclick="document.getElementById('file_pendukung').click()">
                            <input type="file" id="file_pendukung" name="file_pendukung" accept="image/*" class="hidden" onchange="previewFile(this, 3)">
                            <div id="placeholder3">
                            ...
                            <div id="previewWrap3" class="preview-wrap mx-auto">
                                ...
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_pendukung', 3)">
                                    <i class="bi bi-trash3-fill"></i>
                                </button>
                            </div>
                        </div>
...
<script>
    ...
    limitDigit('nik_ortu', 16);
    limitDigit('no_kk', 16);
    limitDigit('nik_anak', 16);
    limitDigit('rt', 3);
    limitDigit('rw', 3);
