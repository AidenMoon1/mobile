...
@section('title', 'KIA Baru - Sukabumi One Access')
...
<section class="form-header">
    ...
    <div class="max-w-4xl mx-auto relative z-10 text-center text-white">
        <div class="reveal">
            ...
            <p class="text-slate-400 mt-2 text-sm">Penerbitan Kartu Identitas Anak (KIA) Baru</p>
        </div>
    </div>
</section>
...
<section class="pb-24 bg-slate-50 min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 form-container">
        ...
        <form action="#" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            {{-- CARD 1: DATA PEMOHON (ORANG TUA & ANAK) --}}
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="input-group-custom md:col-span-2">
                        ...
                        <input type="text" name="nama_orang_tua" placeholder="Masukkan nama sesuai KTP" required>
                    </div>
                    <div class="input-group-custom">
                        <label>NIK Orang Tua (16 Digit)</label>
                        <input type="text" name="nik_orang_tua" id="nik_ortu" maxlength="16" inputmode="numeric" placeholder="3277xxxxxxxx" required>
                    </div>
                    <div class="input-group-custom">
                    ...
                    <div class="input-group-custom">
                        ...
                        <input type="email" name="email_ortu" placeholder="contoh@mail.com" required>
                    </div>
                    <div class="input-group-custom">
                        <label>No. Handphone Orang Tua (WhatsApp)</label>
                        <input type="text" name="phone_ortu" placeholder="08xxxxxxxxx" required>
                    </div>

                    {{-- Separator --}}
                    <div class="md:col-span-2 py-4">
                        <div class="border-t border-slate-100 flex items-center justify-center">
                            <span class="bg-white px-4 text-[10px] font-bold text-slate-300 uppercase tracking-widest -mt-2">Data Anak</span>
                        </div>
                    </div>
                    ...
                    <div class="input-group-custom md:col-span-2">
                        <label>NIK Anak (Lihat di KK)</label>
                    ...
                    <div class="input-group-custom md:col-span-2">
                        ...
                        <textarea name="keterangan" rows="2" placeholder="Tambahkan catatan jika diperlukan..."></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal" style="transition-delay: 100ms">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="input-group-custom md:col-span-2">
                        ...
                        <input type="text" name="alamat_lengkap" placeholder="Nama jalan, nomor rumah, dll" required>
                    </div>
            ...
            <div class="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-xl shadow-slate-200/50 reveal" style="transition-delay: 200ms">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {{-- File 1: Akta Kelahiran --}}
                    <div class="space-y-2">
                        <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Foto Akta Kelahiran</p>
                        <div class="upload-box" onclick="document.getElementById('file_1').click()">
                            <input type="file" id="file_1" name="file_akta" accept="image/*" class="hidden" onchange="previewFile(this, 1)">
                            <div id="ph1"><i class="bi bi-file-earmark-medical text-2xl text-slate-300 block mb-1"></i><span class="text-[9px] font-bold text-slate-400">PILIH GAMBAR</span></div>
                            <div id="previewWrap1" class="preview-wrap mx-auto">
                                <img id="preview1" class="preview-img">
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_1', 1)">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="upload-box" onclick="document.getElementById('file_2').click()">
                            <input type="file" id="file_2" name="file_kk" accept="image/*" class="hidden" onchange="previewFile(this, 2)">
                            <div id="ph2"><i class="bi bi-people text-2xl text-slate-300 block mb-1"></i><span class="text-[9px] font-bold text-slate-400">PILIH GAMBAR</span></div>
                            <div id="previewWrap2" class="preview-wrap mx-auto">
                                <img id="preview2" class="preview-img">
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_2', 2)">
                                    <i class="bi bi-trash3-fill"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    {{-- File 3: KTP-el Ortu --}}
                    <div class="space-y-2">
                        <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Foto KTP-el Orang Tua</p>
                        <div class="upload-box" onclick="document.getElementById('file_3').click()">
                            <input type="file" id="file_3" name="file_ktp_ortu" accept="image/*" class="hidden" onchange="previewFile(this, 3)">
                            <div id="ph3"><i class="bi bi-person-vcard text-2xl text-slate-300 block mb-1"></i><span class="text-[9px] font-bold text-slate-400">PILIH GAMBAR</span></div>
                            <div id="previewWrap3" class="preview-wrap mx-auto">
                                <img id="preview3" class="preview-img">
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_3', 3)">
                                    <i class="bi bi-trash3-fill"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    {{-- File 4: Pas Foto --}}
                    <div class="space-y-2">
                        <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Pas Foto Anak (> 5 Thn)</p>
                        <div class="upload-box" onclick="document.getElementById('file_4').click()">
                            <input type="file" id="file_4" name="file_foto_anak" accept="image/*" class="hidden" onchange="previewFile(this, 4)">
                            <div id="ph4"><i class="bi bi-image text-2xl text-slate-300 block mb-1"></i><span class="text-[9px] font-bold text-slate-400">PILIH GAMBAR</span></div>
                            <div id="previewWrap4" class="preview-wrap mx-auto">
                                <img id="preview4" class="preview-img">
                                <button type="button" class="remove-preview-btn" onclick="removePreview(event, 'file_4', 4)">
                                    <i class="bi bi-trash3-fill"></i>
                                </button>
                            </div>
                        </div>
            ...
            {{-- SUBMIT --}}
            <button type="submit" class="w-full py-5 bg-primary text-white rounded-2xl font-black text-sm shadow-xl shadow-primary/20 hover:bg-primary-dark transition-all uppercase tracking-[0.2em] reveal">
                Kirim Permohonan KIA <i class="bi bi-send-fill ml-2"></i>
            </button>
