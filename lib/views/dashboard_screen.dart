...
class _DashboardScreenState extends State<DashboardScreen> {
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      // BOTTOM BAR ORANGE "Lihat Semua Sektor" (Bisa diklik ke LayananScreen)
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
  ...
  // # WIDGET HELPER: KARTU SEKTOR WHITE (DENGAN TEKS DI DALAM BOTTOM BAR)
  Widget _buildSectorCard(String title, IconData icon, {bool hasDropdown = false}) {
    return Container(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          // # Bagian Ikon Utama di Tengah Kartu Putih
          Expanded(
            child: Center(
              child: Icon(icon, color: const Color(0xFF123457), size: 75),
            ),
          ),

          // # BOTTOM BAR ABU-ABU (Tempat Teks Judul & Panah)
          Container(
            width: double.infinity,
  ...
  Widget _buildInstansiCard(String title, String? assetPath, IconData fallbackIcon) {
    final bool isLainnya = title == 'Lainnya';
    // 💡 3 Kotak Utama (70x44) & Kotak Lainnya Lebih Kecil (44x38)
    final double cardWidth = isLainnya ? 44.0 : 70.0;
    final double cardHeight = isLainnya ? 35.0 : 40.0;
    final double iconSize = isLainnya ? 20.0 : 24.0;
        ...
        Container(
          ...
          child: assetPath != null
              ? Image.asset(
                  assetPath,
                  fit: BoxFit.contain,
                  errorBuilder: (context, error, stackTrace) => Icon(fallbackIcon, color: const Color(0xFF123457), size: iconSize),
                )
              : Icon(fallbackIcon, color: const Color(0xFF123457), size: iconSize),
        ),
