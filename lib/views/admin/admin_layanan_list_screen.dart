  ...
  void _konfirmasiHapus(BuildContext context, LayananModel layanan) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Apakah Anda yakin ingin menghapus "${layanan.rawTitle}" dari daftar layanan?',
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        // HEADER: TITLE & SUBTITLE & + TAMBAH LAYANAN BUTTON
                        Padding(
                        ...
                        // SEARCH BAR INPUT: CARI NAMA LAYANAN...
                        Padding(
                                        ...
                                        onSelected: (value) {
                                          if (value == 'edit') {
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                builder: (context) => AdminFormLayananScreen(layanan: layanan),
                                              ),
                                            );
                                          } else if (value == 'hapus') {
                                            _konfirmasiHapus(context, layanan);
                                          }
                                        },
                                        itemBuilder: (context) => [
                                          const PopupMenuItem(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // NAV ITEM 3: KELOLA LAYANAN (SELECTED)
          _buildSidebarNavItem(
            isSelected: true,
